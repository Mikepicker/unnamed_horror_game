...
OBJS = game/main.o game/game.o game/ui.o game/input.o engine/glad.o engine/shader.o engine/renderer.o engine/importer.o engine/audio.o engine/dict.o engine/render_list.o engine/factory.o engine/debug.o engine/physics.o engine/skybox.o engine/animator.o engine/data/object.o engine/data/mesh.o engine/data/material.o engine/data/skeleton.o engine/data/frame.o engine/data/animation.o 
